        ...
        <section className="introduction">
          <div className="limited-width">
            <article className="introduction-description">
              ...
              <p>
                I aspire to become a Full Stack Developer and have experience in
                building applications and websites using Flutter and web
                technologies. I enjoy coding, so if I think I can create an
                application, I'll try to do it in my free time. :)
              </p>
              <p>
